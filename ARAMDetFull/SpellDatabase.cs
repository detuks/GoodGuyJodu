...
namespace ARAMDetFull
{
    public static class SpellDatabase
    {
        ...
        static SpellDatabase()
        {
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    SpellName = "AatroxQ",
                    Slot = SpellSlot.Q,
                    Type = SpellData.SkillShotType.SkillshotCircle,
                    Delay = 600,
                    Range = 650,
                    Radius = 250,
                    MissileSpeed = 2000,
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    SpellName = "AatroxE",
                    Slot = SpellSlot.E,
                    Type = SpellData.SkillShotType.SkillshotMissileLine,
                    Delay = 250,
                    Range = 1075,
                    Radius = 35,
                    MissileSpeed = 1250,
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    Slot = SpellSlot.W,
                    Type = SpellData.SkillShotType.SkillshotCone,
                    Delay = 250,
                    Range = 825,
                    Radius = 80,
                    MissileSpeed = int.MaxValue,
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    SpellName = "GnarBigW",
                    Slot = SpellSlot.W,
                    Type = SpellData.SkillShotType.SkillshotLine,
                    Delay = 600,
                    Range = 600,
                    Radius = 80,
                    MissileSpeed = int.MaxValue,
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    Slot = SpellSlot.E,
                    Type = SpellData.SkillShotType.SkillshotRing,
                    Delay = 250,
                    Range = 600,
                    Radius = 80,
                    MissileSpeed = int.MaxValue,
        ...
        public static List<SpellData> getChampionSkillshots(string champName)
        {
            List<SpellData> champSpells = new List<SpellData>();
            foreach (var spellData in Spells)
            {
                if (spellData.ChampionName == champName)
                {
                    champSpells.Add(spellData);
                }
            }
            return champSpells;
        }
