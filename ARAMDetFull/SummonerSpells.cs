...
namespace ARAMDetFull
{
    ...
    class SummonerSpells
    {
        ...
        {
            Game.PrintChat(sum1.Instance.Name);
            ...
            Game.PrintChat(sum2.Instance.Name);
        ...
        class SnowBall : SumSpell
        {
            ...
            public override void useSpell()
            {
                ...
                if (spell.Instance.Name.Equals("snowballfollowupcast"))
                {
                    if (snowed != null)
                    {
                        if (player.HealthPercent > 30 && snowed.HealthPercent < 45 && MapControl.balanceAroundPointAdvanced(snowed.Position.To2D(), 450) > 0)
                            spell.Cast();
                    }
                }
                else
