    ...
    public static class TargetSpellDatabase
    {
        ...
        static TargetSpellDatabase()
        {
            Spells = new List<TargetSpellData>
            {
                ...
                new TargetSpellData("nami", "namie", SpellSlot.E, SpellType.Self, CcType.Slow, 800, 500, float.MaxValue),
        ...
        public static List<TargetSpellData> getChampionTargSpell(string champName)
        {
            List<TargetSpellData> champSpells = new List<TargetSpellData>();
            foreach (var spellData in Spells)
            {
                if (spellData.ChampionName.ToLower() == champName.ToLower())
                {
