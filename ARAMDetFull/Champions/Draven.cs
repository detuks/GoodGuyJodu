...
namespace ARAMDetFull.Champions
{
    class Draven : Champion
    {
        ...
        {
            return Utility.CountEnemysInRange(player, (int)range) >= numOfEnemy;
        }
        ...
        public void CastEHitchance(Obj_AI_Hero target)
        {
        ...
        private void CastRExecute(Obj_AI_Hero RTarget)
        {
        ...
        private void RExecute(Obj_AI_Hero RTarget)
        {
            var Pred = R.GetPrediction(RTarget);
            if (!RTarget.IsValidTarget() || Pred.Hitchance < HitChance.Medium || !R.IsReady()) return;
        ...
        private  bool getUnitsInPath(Obj_AI_Hero player, Obj_AI_Hero target, Spell spell)
        {
