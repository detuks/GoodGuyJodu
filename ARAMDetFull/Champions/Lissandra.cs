...
namespace ARAMDetFull.Champions
{
    class Lissandra : Champion
    {
        ...
        private bool CastW(Obj_AI_Hero target)
        {
        ...
        private bool CastE(Obj_AI_Hero target)
        {
        ...
        public bool IsKillableFromPoint(Obj_AI_Hero target, Vector3 Point, bool ExcludeE = false)
        {
        ...
        float GetAvailableDamage(Obj_AI_Hero target)
        {
        ...
        bool CastR(Obj_AI_Hero currenttarget)
        {
            var Check =
                HeroManager.Enemies
                    .Where(
