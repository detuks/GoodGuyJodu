...
namespace ARAMDetFull.Champions
{
    class Jayce : Champion
    {
        ...
        public Obj_AI_Hero lockedTarg = null;
        ...
        private void OnPosibleToInterrupt(Obj_AI_Hero sender, Interrupter2.InterruptableTargetEventArgs args)
        {
        ...
        public void doCombo(Obj_AI_Hero target)
        {
            castOmen(target);
            if (!isHammer)
            {
        ...
        public void doFullDmg(Obj_AI_Hero target)
        {
            castIgnite(target);
        ...
        public void castQPred(Obj_AI_Hero target)
        {
            if (isHammer)
                return;
        ...
        public  Obj_AI_Hero getClosestEnem()
        {
        ...
        public bool shouldIKnockDatMadaFaka(Obj_AI_Hero target)
        {
        ...
        public bool useSmartKnock(Obj_AI_Hero target)
        {
        ...
        public void castEonSpell(Obj_AI_Hero mis)
        {
        ...
        public void castOmen(Obj_AI_Hero target)
        {
        ...
        public void drawCD()
        {
            ...
            if (isHammer)
            {
                if (rangQCDRem == 0)
                    ...
                    Drawing.DrawText(pScreen.X - 60, pScreen.Y, System.Drawing.Color.Red, format: "Q: " + rangQCDRem.ToString("0.0"));
