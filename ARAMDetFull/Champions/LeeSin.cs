...
namespace ARAMDetFull.Champions
{
    class LeeSin : Champion
    {
        ...
        {
            if (!W.IsReady() || sender == null || args.Target == null || sender.IsAlly || !(sender is Obj_AI_Hero) || !(args.Target is Obj_AI_Hero) || !args.Target.IsAlly || safeGap((Obj_AI_Hero)args.Target))
                return;
            if (W.IsInRange(args.Target))
                W.CastOnUnit((Obj_AI_Hero)args.Target);
        }
